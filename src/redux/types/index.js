...
export const CLEAR_ALERTS_SUCCESS = 'CLEAR_ALERTS_SUCCESS';
export const ADD_ERROR_ALERT = 'ADD_ERROR_ALERT';
export const CLEAR_ALERTS_ERROR = 'CLEAR_ALERTS_ERROR';
...
export const OPEN_BASKET_MODAL_STATUS = 'OPEN_BASKET_MODAL_STATUS';
export const OPEN_BASKET_MODAL_STATUS_SUCCESS = 'OPEN_BASKET_MODAL_STATUS_SUCCESS';

export const CLOSE_BASKET_MODAL_STATUS = 'CLOSE_BASKET_MODAL_STATUS';
export const CLOSE_BASKET_MODAL_STATUS_SUCCESS = 'CLOSE_BASKET_MODAL_STATUS_SUCCESS';